// createSketch allows us to create a new sketch function that has a specific
// div ID. This allows us to create multiple versions of the same sketch.
//
// by passing in div ID, we can set the width and height based on the div width/height.
let createSketch = function(divId) {
  // Wrap the entire sketch in a function that takes in a p5 instance.
  // We'll use this at the very bottom to generate new P5 sketches.
